...
if(isset($_POST["crearProducto"])){
    ...
    if($nombre != "" && $precioCompra > 0 && $precioVenta > 0 && $cantidad > 0 && $marcaId != ""){
        $producto = new Producto(null, $nombre, $cantidad, $precioCompra, $precioVenta, $marcaId);
        $producto->crear();
        $success = true;  // Producto creado con éxito
    } else {
        $error = true;  // Error en los datos del formulario
    }
}
?>
